...
// 학생 성적 정보를 담을 수 있는 자료형 틀 만들기

// 멤버변수 + 멤버매서드 ( 멤버변수를 사용하는 매서드 )
// 멤버매서드는 객체가 생성된 이후부터 사용가능하다

// type 정의함 주의사항 : 변수가 만들어진것 아님 
public class Score {
	...
	// 반환타입 명시하면 안됨 주의사항 ( 반환타입 있으면 일반 매서드로 간주 )
	// 이름이 반드시 클래스명과 동일해야됨 (대소문자 가림 주의)
	...
	public Score(String name) {
		this(name, 60, 60, 60);
		/*
		 * 생성자끼리 서로 호출할 수 있다. 단 반드시 첫 줄에 와야한다 생성자 호출시 this() 표현으로 호출함
		 */
		/*
		 * 수정=> 생성자 호출 코드로 변경 this.name = name; this.kor = 60; this.eng = 60; this.math
		 * = 60;
		 */
	}
	...
	public void printInfo() { // 여기있는 this는 생략가능 System.out.println(name);
