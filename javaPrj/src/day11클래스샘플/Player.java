...
public class Player {
	...
	private int volume;
	private String[] list = { "After LIKE", "Pink Venom", "새삥", "Shut down", "Attentin", "Hype BOY", "LOVE DIVE",
			"FROEVER 1", "그때 그순간 그대로", "Cookie", "사랑은 늘 도망가", "보고싶었어", "우리들의 블루스", "그랑데이션", "다시 만날 수 있을까", "TOMBOY",
			"LAW", "사랑인가 봐 " };
